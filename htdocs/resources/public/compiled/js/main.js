...
var renderWordCloud = require("./setup/renderwordcloud.js"),
...
},{"./setup/renderwordcloud.js":3,"./setup/setupclickevents.js":4,"./topics/topics.json":5,"jquery":7}],2:[function(require,module,exports){
"use strict";
...
},{"./renderstatistics.js":2}],5:[function(require,module,exports){
module.exports={
    "topics": [
        {
...
var TopicReader = {
     ...
     * @returns {Array}
     */
    transformTopicObj: function transformTopicObj(topicsObj) {
        var skew = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "balanced";

        var volumeToFontSize = this.mapVolumeToFontsize(topicsObj, skew);

        var transformedTopics = topicsObj.topics.map(function (topic) {
            ...
            for (var i = 0; i < volumeToFontSize.length; i++) {
     ...
     * @returns {Array}
     */
    mapVolumeToFontsize: function mapVolumeToFontsize(topicsObj) {
        var skew = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "balanced";
     ...
     * @returns {Number}
     */
    getHighestVolume: function getHighestVolume(topics) {
        return Math.max.apply(Math, topics.map(function (topic) {
            return topic.volume;
        }));
    },
     ...
     * @returns {Number}
     */
    getLowestVolume: function getLowestVolume(topics) {
        return topics.length <= 1 ? 0 : Math.min.apply(Math, topics.map(function (topic) {
            return topic.volume;
        }));
    },
